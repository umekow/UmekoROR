class Student
 ...
 def initialize (first_name, last_name, email = nil, username = nil, password = nil)
...
student_001 = Student.new("Umeko", "Walker", "Umekow@email.com")
student_001.first_name = "Meko"
